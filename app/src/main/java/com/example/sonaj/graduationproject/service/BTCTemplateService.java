...
package com.example.sonaj.graduationproject.service;
...
import com.example.sonaj.graduationproject.bluetooth.BluetoothManager;
import com.example.sonaj.graduationproject.bluetooth.ConnectionInfo;
import com.example.sonaj.graduationproject.bluetooth.TransactionBuilder;
import com.example.sonaj.graduationproject.bluetooth.TransactionReceiver;
import com.example.sonaj.graduationproject.contents.CommandParser;
	...
	class ServiceHandler extends Handler
	{
		...
		public void handleMessage(Message msg) {
			...
			case BluetoothManager.MESSAGE_STATE_CHANGE:
				// Bluetooth state Changed
				Logs.e(TAG, "Service - MESSAGE_STATE_CHANGE: " + msg.arg1);
			...
			case BluetoothManager.MESSAGE_WRITE:
				Logs.e(TAG, "Service - MESSAGE_WRITE: ");
				break;

			// Received packets from remote
			case BluetoothManager.MESSAGE_READ:
				Logs.e(TAG, "Service - MESSAGE_READ: ");
			...
			case BluetoothManager.MESSAGE_TOAST:
				Logs.e(TAG, "Service - MESSAGE_TOAST: ");
...
//				Logs.e(TAG, "# Result code = "+strResult);
//			}
