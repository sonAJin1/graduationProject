...
public class ItemWeekHotMovie {
    ...
    public ItemWeekHotMovie(String title, String subtitle, int date, float naverScore, float IMDBScore, int RTTomatoScore, String director, String actor, String summary, String contents, String imageUrl, boolean like, int likeCount, int type) {
