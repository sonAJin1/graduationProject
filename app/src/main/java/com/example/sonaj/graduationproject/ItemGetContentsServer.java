...
public class ItemGetContentsServer {
    ...
    public ItemGetContentsServer (String title, String subTitle, String contents, String actor, String director, String summary, String imgURL,
